...
public class EluVisualisationDAO {
    ...
    public List<String> listerFederations()
            throws SQLException {
        ...
        String sql =
            "SELECT code_federation, nom_federation " +
            "FROM federation " +
            "ORDER BY nom_federation";
    ...
    public List<ClassementCommune>
    getClassementCommunes(
            String nomRegion,
        ...
        StringBuilder sql =
            ...
            "COALESCE(SUM(sl.total_licencies), 0) " +
            "AS total_licencies, " +

            "ROUND(" +
            "SUM(sl.total_licencies) * 100.0 / " +
            "SUM(SUM(sl.total_licencies)) OVER (), " +
            "2" +
            ") AS taux " +
            ...
            "JOIN commune c " +
            "ON c.code_commune = sl.code_commune " +

            "JOIN region r " +
            "ON r.code_region = c.code_region " +

            "JOIN federation f " +
            "ON f.code_federation = sl.code_federation " +
    ...
    public int getTotalFiltre(
            String nomRegion,
            String codeFederation,
            String nomCommune
    ) throws SQLException {

        return executerTotal(
                nomRegion,
                codeFederation,
                nomCommune,
                "sl.total_licencies",
    ...
    public int getTotalFemmesFiltre(
            String nomRegion,
            String codeFederation,
            String nomCommune
    ) throws SQLException {
    ...
    public int getTotalHommesFiltre(
            String nomRegion,
            String codeFederation,
            String nomCommune
    ) throws SQLException {
