...
<head>
    ...
    <title>Espace Elus | Dashboard</title>
...
<div class="d-flex">
    ...
    <main class="main-content">
        <div class="container-fluid">
            <div class="mb-5">
                <h1 class="h2 fw-bold mb-1">Espace Elus</h1>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card stat-card shadow-sm h-100">
                        <div class="card-body p-4">
                            ...
                            <p class="text-muted small">Analyse croisee par commune, genre et fededration sur votre territoire.</p>
              ...
              <p class="text-muted small">Classement des communes et repartition H/F par region et federation.</p>
             <a href="<%= request.getContextPath() %>/elu/visualisation" class="btn btn-success btn-sm w-100 rounded-pill mt-3">
                Acceder au module
            </a>
        </div>
    </div>
