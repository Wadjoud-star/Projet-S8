...
public class ConnexionDB {
	...
	private static final String URL = "jdbc:mysql://mysql:3306/clubs_sportifs";//docker
    //private static final String URL      = "jdbc:mysql://localhost:3307/clubs_sportifs";//localhost
